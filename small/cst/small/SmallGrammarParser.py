...
def serializedATN():
    return [
        ...
        0,0,58,59,1,0,0,0,59,60,1,0,0,0,60,61,5,9,0,0,61,62,3,10,5,0,62,
        ...
        0,0,0,71,72,5,28,0,0,72,7,1,0,0,0,73,79,3,12,6,0,74,75,5,6,0,0,75,
        76,3,10,5,0,76,77,5,7,0,0,77,79,1,0,0,0,78,73,1,0,0,0,78,74,1,0,
        0,0,79,9,1,0,0,0,80,82,3,12,6,0,81,80,1,0,0,0,82,85,1,0,0,0,83,81,
        ...
        144,141,1,0,0,0,144,142,1,0,0,0,144,143,1,0,0,0,145,31,1,0,0,0,146,
        147,3,38,19,0,147,148,3,42,21,0,148,149,3,38,19,0,149,33,1,0,0,0,
        150,151,3,38,19,0,151,152,3,44,22,0,152,153,3,38,19,0,153,35,1,0,
...
class SmallGrammarParser ( Parser ):
    ...
    def stmtList(self):
        ...
        self.enterRule(localctx, 10, self.RULE_stmtList)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 83
